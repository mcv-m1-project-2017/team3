function visualize_histograms(img_dir, mask_dir, gt_dir, train_files, group_by)
...
switch(group_by)
    case 'type'
        ...
        subplot(1,3,1); histogram(H_A); title('H (signal A)');
        subplot(1,3,2); histogram(Cb_A); title('Cb (signal A)');
        subplot(1,3,3); histogram(Cr_A); title('Cr (signal A)');
        figure % display histograms for signals of type B
        subplot(1,3,1); histogram(H_B); title('H (signal B)');
        subplot(1,3,2); histogram(Cb_B); title('Cb (signal B)');
        subplot(1,3,3); histogram(Cr_B); title('Cr (signal B)');
        figure % display histograms for signals of type C
        subplot(1,3,1); histogram(H_C); title('H (signal C)');
        subplot(1,3,2); histogram(Cb_C); title('Cb (signal C)');
        subplot(1,3,3); histogram(Cr_C); title('Cr (signal C)');
        figure % display histograms for signals of type D
        subplot(1,3,1); histogram(H_D); title('H (signal D)');
        subplot(1,3,2); histogram(Cb_D); title('Cb (signal D)');
        subplot(1,3,3); histogram(Cr_D); title('Cr (signal D)');
        figure % display histograms for signals of type E
        subplot(1,3,1); histogram(H_E); title('H (signal E)');
        subplot(1,3,2); histogram(Cb_E); title('Cb (signal E)');
        subplot(1,3,3); histogram(Cr_E); title('Cr (signal E)');
        figure % display histograms for signals of type F
        subplot(1,3,1); histogram(H_F); title('H (signal F)');
        subplot(1,3,2); histogram(Cb_F); title('Cb (signal F)');
        subplot(1,3,3); histogram(Cr_F); title('Cr (signal F)');
    case 'color'
