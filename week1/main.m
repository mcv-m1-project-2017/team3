...
% summarize daya per each signal
...
%% TASK 2: CREATE TRAINING AND VALIDATION DATASETS
...
fprintf('    TASK 2. Training set and validation set successfully splitted.\n')
fprintf('               -> Training set: %i%% of the sample images\n',train*100);
fprintf('               -> Validation set: %i%% of the sample images\n',100-(train*100));  
         

%% TASK 3: COLOR SEGEMENTATION TO CREATE MASKS
...
[masks, timexframe] = compute_masks(img_dir, valid_files, seg_type, size_filt, hole_fill);
...
fprintf('    TASK 4. Pixel-based evaluation successfully completed.\n')
