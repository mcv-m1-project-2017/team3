...
[masks, timexframe] = compute_masks(test_dir, test_files, seg_type, size_filt, hole_fill, noise_filt, hist_comp);
...
for i=1:length(test_files)
    imwrite(masks{i},['../test_2017/test/method1/mask.',test_files{i}(1:end-3),'png']);
end